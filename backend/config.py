...
OPENAI_CHAT_MODEL_SLIDES = os.getenv("OPENAI_CHAT_MODEL_SLIDES", "gpt-5-mini")
...
LANGSMITH_PROJECT = os.getenv("LANGSMITH_PROJECT", os.getenv("LANGCHAIN_PROJECT", "genai-smart-education-platform"))
